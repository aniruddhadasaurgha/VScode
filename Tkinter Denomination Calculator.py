...
label1 = Label(root, text="Hey user! Welcome to Denomination Counter Application", font=("Aptos", 20), bg = "light blue")
label1.place(x = 0.5, y = 340, anchor = CENTER)
def msg():
    Msgbox = messagebox.showinfo("Alert","Do you want to calculate the denomination count?")
    if Msgbox == "ok":
        topwin()
button1 = Button(root, text="Let's get started!", font=("Aptos", 15), bg = "brown",fg = "white" command = msg)
